...
var getTemplate = function getTemplate() {
  ...
  var items = data.map(function (el) {
    return "<li class=\"select__item\"\n\t\t\tdata-type='item' data-value=\"".concat(el.id, "\"\n\t\t\t> ").concat(el.id, ".  ").concat(el.value, " </li>");
  });
...
window.s = select; //parcel index.html
},{"./select/select":"select/select.js","./style/styles.scss":"style/styles.scss"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/Select%20JS.e31bb0bc.js.map